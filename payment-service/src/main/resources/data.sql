...
-- Insertion de portefeuilles utilisateurs de test
INSERT INTO wallets (user_id, card_id, balance, currency, status) VALUES
('USR_1001', 'CARD_NFC_883921', 5000.00, 'XOF', 'ACTIVE'),
('USR_1002', 'CARD_NFC_441209', 1200.00, 'XOF', 'ACTIVE'),
('USR_1003', 'CARD_NFC_772183', 150.00, 'XOF', 'ACTIVE');
...
('TX_WAVE_9981273', 'USR_1001', 'CARD_NFC_883921', 'RECHARGE_WAVE', 5000.00, 5000.00, 'XOF', 'SUCCESS', 'WAVE', NULL, NULL, NULL, 'Recharge via Wave Mobile Money', CURRENT_TIMESTAMP),
('TX_RIDE_1092834', 'USR_1001', 'CARD_NFC_883921', 'RIDE_DEBIT', 500.00, 4500.00, 'XOF', 'SUCCESS', 'WALLET', 'RIDE_9921', 'LINE_01', 'BUS_A102', 'Validation trajet Bus A102', CURRENT_TIMESTAMP),
('TX_WAVE_4481920', 'USR_1002', 'CARD_NFC_441209', 'RECHARGE_WAVE', 2000.00, 2000.00, 'XOF', 'SUCCESS', 'WAVE', NULL, NULL, NULL, 'Recharge via Wave Mobile Money', CURRENT_TIMESTAMP);
...
('USR_1003', 'CARD_NFC_772183', 'INSUFFICIENT_FUNDS_REPEATED', 'MEDIUM', 'Tentative de validation de trajet avec solde insuffisant (150 XOF)', CURRENT_TIMESTAMP, false);
